...
A multi-agent system built with LangGraph and SQLite that automates health insurance claims processing. Covers eligibility verification, claim creation, and audit.
